...
def save_parameters(parameters:dict):
    ...
    args = json.dumps({"MaintenancePathPrefix":parameters["MaintenancePathPrefix"],
...
with DAG(
    dag_id='jupiter_merge_scenario_data',
...
# Get dag parameters from vault    
    ...
    build_model = DataprocCreatePysparkJobOperator(
        ...
        main_python_file_uri='hdfs:///SRC/JUPITER/UPLOAD_FROM_SCENARIO/MERGE_SCENARIO_DATA.py',
        python_file_uris=[
