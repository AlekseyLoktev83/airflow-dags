...
#     schedule_interval='20 7 * * *',
    ...
    trigger_jupiter_calculation_dispatcher = TriggerDagRunOperator(
        ...
        conf={"parent_run_id":"{{run_id}}","parent_process_date":"{{ds}}","schema":SCHEMA,"parent_handler_id":"{{ti.xcom_pull(task_ids='handler_id')}}"},
        wait_for_completion = True,
    )
    ...
    handler_id >> trigger_jupiter_start_night_processing >> trigger_jupiter_calculation_dispatcher >> trigger_jupiter_calculation_dispatcher
#     Success branch
    trigger_jupiter_end_night_processing >> trigger_jupiter_move_logs_to_sftp >> trigger_jupiter_move_promo_to_archive
#     Error branch
    trigger_jupiter_error_processing >> trigger_jupiter_error_end_night_processing >> trigger_jupiter_error_move_logs_to_sftp >> trigger_jupiter_error_move_promo_to_archive
