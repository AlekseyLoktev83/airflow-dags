...
def generate_upload_script(prev_task, src_dir, src_file, upload_path, bcp_parameters, current_upload_date, last_upload_date):
    ...
    entities_df = mssql_scripts.mip_generate_table_select_query(
...
with DAG(
    dag_id='mip_raw_data_upload_chunks',
...
# Upload entities from sql to hdfs in parallel
    upload_tables = BashOperator.partial(task_id="upload_tables", do_xcom_push=True,execution_timeout=datetime.timedelta(minutes=180), retries=3).expand(
